---
date: 2016-02-10T13:22:22+09:00
draft: false
...
Here are a couple of image examples: an image:/images/asciidoc-article/github-mark.png[]
example inline image followed by an example block image:

.Tiger block image
image::asciidoc-article/github-mark.png[Tiger image]
